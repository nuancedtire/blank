...
export const listAll = query({
  ...
  handler: async (ctx) => {
    ...
    // BOLT OPTIMIZATION: Resolve N+1 query bottleneck by batch-fetching notification creators.
    // This reduces the number of database roundtrips from O(N) to O(1) plus the initial query.
